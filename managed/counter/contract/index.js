...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      increment: async (...args_1) => {
        ...
        const secretIncrement_0 = args_1[1];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.callContext.currentQueryContext != undefined)) {
          __compactRuntime.typeError('increment',
                                     'argument 1 (as invoked from Typescript)',
                                     'counter.compact line 19 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        if (!(typeof(secretIncrement_0) === 'bigint' && secretIncrement_0 >= 0n && secretIncrement_0 <= 4294967295n)) {
          __compactRuntime.typeError('increment',
        ...
        const partialProofData = {
          input: {
            value: _descriptor_0.toValue(secretIncrement_0),
  ...
  async _increment_0(context, partialProofData, secretIncrement_0) {
    const tmp_0 = ((t1) => {
                    if (t1 > 4294967295n) {
                      throw new __compactRuntime.CompactError('counter.compact line 20 char 22: cast from Field or Uint value to smaller Uint value failed: ' + t1 + ' is greater than 4294967295');
                    }
                    return t1;
...
export const expectedVk = {
  'increment': 'ecbd1edcaf24ad5370440cf6fc5e872d104fd81c40bc60d452c15830b59198ee',
};
